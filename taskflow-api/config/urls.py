...
urlpatterns = [
    ...
    path("api/auth/webauthn/register/", user_views.BiometricRegisterOptionsView.as_view(), name="auth-webauthn-register"),
    path("api/auth/webauthn/register/verify/", user_views.BiometricRegisterVerifyView.as_view(), name="auth-webauthn-register-verify"),
    path("api/auth/webauthn/authenticate/", user_views.BiometricLoginOptionsView.as_view(), name="auth-webauthn-authenticate"),
    path("api/auth/webauthn/authenticate/verify/", user_views.BiometricLoginVerifyView.as_view(), name="auth-webauthn-authenticate-verify"),
    path("api/auth/webauthn/remove/<int:pk>/", user_views.BiometricCredentialDeleteView.as_view(), name="auth-webauthn-remove"),
